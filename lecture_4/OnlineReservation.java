...
public class OnlineReservation{
    ...
    private static boolean[] s = new boolean[10]; // initialize an array of 10 seats, all empty
    ...
    private static void reserveSeat() {
        ...
        } else if (s[seatNumber - 1]) {
            System.out.println("Seat already reserved!");
        } else {
            s[seatNumber - 1] = true; // reserve the seat
    ...
    private static void cancelReservation() {
        ...
        if (seatNumber < 1 || seatNumber > 10) {
            ...
            s[seatNumber - 1] = false; // unreserve the seat
